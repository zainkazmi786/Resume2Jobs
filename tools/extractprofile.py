...
def get_optimized_keywords(text):
    ...
    try:
        ...
        - **Extract 3-5 most relevant and specific job titles from the resume that are likely to be found on linkedin and are relevant to the text (the person is likely to as those job titles) **  
